...
String &String::copy_String(const String &source) {
  if (GLOBAL_DEBUG)
...
// appends a String at the end of the String
String String::append_string_main(char *c) const {
  if (GLOBAL_DEBUG)
...
// appends a String at the end of the String
String String::append_string(string &str) const {
  if (GLOBAL_DEBUG)
...
String String::remove_string(char substr) const {
  if (GLOBAL_DEBUG)
...
String String::remove_string(const String &substr) const {
  if (GLOBAL_DEBUG)
...
String String::remove_string(const string &substr) const {
  if (GLOBAL_DEBUG)
    cout << "Calling remove_string 1 Fn with args:" << substr << "OOO" << endl;
...
String String::remove_string_main(char *str) const {
  if (GLOBAL_DEBUG)
...
// removes the substr from the String
String String::remove_string(const char *substr) const {
  if (GLOBAL_DEBUG)
    cout << "Calling remove_string 1x Fn with args:" << substr << endl;
  // char *temp = new char[length(substr)];
}
// copies one String to another
String &String::assign_string(const String &source) {
  if (GLOBAL_DEBUG)
...
// copies one string to another
String &String::assign_string(const string &s) {
  if (GLOBAL_DEBUG)
...
// main str copier
String String::assign_string_main(char *str) {
  int i = 0;
  int l = length(str);
  data = new char[l];
  for (i = 0; i < l; i++) {
...
bool String::isEqual(const String &b) const {
  if (GLOBAL_DEBUG)
...
// returns true if two Strings are equal
bool String::isEqual(const string &) const {
  if (GLOBAL_DEBUG)
    cout << "Calling isEqual 1 Fn with args:" << endl;
}
// returns true if two strings are equal
bool String::isEqual(char *s) const {
  if (GLOBAL_DEBUG)
...
int String::length(char *str) const {
  if (GLOBAL_DEBUG)
    cout << "Calling Length Fn with args:" << endl;
...
char *String::fill(char *tgt, char c, int len) {
  int lengthTgt;
  if (len == 0)
    lengthTgt = length();
  else
...
char *String::concat(char *a, char *b) const {
...
char *String::push_left(char *tgt, char *load) {
